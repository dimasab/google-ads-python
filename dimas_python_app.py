...
###########################################################################################################################
######################################################## MULAI APP ########################################################
def python_update_ad_googleads(google_ads_customer_id, ad_id, jenisproduk, merekproduk, namaproduk, spesifikasiproduk, hargaproduk, lokasitoko, urltarget):
...
###########################################################################################################################
######################################################## MULAI APP ########################################################
def python_update_locations_googleads(google_ads_customer_id, id_kampanye, lokasitoko):
...
def semua():
    ...
    for product in array_produk_seller:
        ...
        if (product.get("acf")['google_ads_campaign_id'] and
            ...
            python_update_ad_googleads(google_ads_customer_id, id_ad, jenisproduk, merekproduk, namaproduk, spesifikasiproduk, hargaproduk, lokasitoko, urltarget)
            # python_update_keyword_googleads(google_ads_customer_id, id_adgroup, merekproduk_cut, namaproduk_cut, spesifikasiproduk_cut)
            python_update_locations_googleads(google_ads_customer_id, id_kampanye, lokasitoko)
        else:
